        ...
        try:
            ...
            if user_id:
                ...
                if es_valido:
                    ...
                    uompoid_name = post['params']['uompoid']
                    uompo_name = False
                    if uompoid_name == 'KG':
                        uompo_name = 'KG'
                    elif uompoid_name == 'LT':
                        uompo_name = 'LT'
                    elif uompoid_name == 'TM':
                        uompo_name = 'TM'

                    if not uompo_name:
                        uompo_name = f"{uompoid_name} {contenidoenvase} {post['params']['unidadreferencia']}"
                    ...
                    if product_id:
                        ...
                        purchase_line = request.env['purchase.order.line'].search(
                        ...
                        self.create_message_log("WS017", as_token, post, 'ACEPTADO',
        ...
        try:
            ...
            if user_id:
                ...
                if es_valido:
                    ...
                    if object_model:
                        object_model.write({
                            'f_closed': post['params']['flagclosed']
                        })
